...
rootNode:"div.spoiler",contentSelector:'$(rootNode).find("div.hidemain").html()'},sub:{title:"\u041f\u043e\u0434\u0441\u0442\u0440\u043e\u0447\u043d\u044b\u0439 \u0442\u0435\u043a\u0441\u0442",buttonHTML:'<span class="ve-tlb-sub"></span>',command:'new NativeCommand("subscript")',bbName:"sub",bbOpen:"[sub]",bbClose:"[/sub]",htmlToBB:{sub:"[sub]%$(this).html()%[/sub]"},bbToHTML:{"[sub](.*?)[/sub]":"<sub>$1</sub>"}},sup:{title:"\u041d\u0430\u0434\u0441\u0442\u0440\u043e\u0447\u043d\u044b\u0439 \u0442\u0435\u043a\u0441\u0442",
buttonHTML:'<span class="ve-tlb-sup"></span>',command:'new NativeCommand("superscript")',bbName:"sup",bbOpen:"[sup]",bbClose:"[/sup]",htmlToBB:{sup:"[sup]%$(this).html()%[/sup]"},bbToHTML:{"[sup](.*?)[/sup]":"<sup>$1</sup>"}},quote:{title:"\u0412\u0441\u0442\u0430\u0432\u0438\u0442\u044c \u0446\u0438\u0442\u0430\u0442\u0443",buttonHTML:'<span class="ve-tlb-quote"></span>',command:'new CustomCommand("quote")',htmlOpen:'<div class="blockquote">',htmlClose:"</div></div>",bbName:"quote",bbOpen:"[quote]",
bbClose:"[/quote]",htmlToBB:{"div.blockquote":"[quote]%$(this).html()%[/quote]"},rootNode:"div.blockquote",contentSelector:"$(rootNode).html()"},wbbConvertation:{htmlToBB:{td:"[td]%$(this).html()%[/td]",tr:"[tr]%$(this).html()%[/tr]",table:"[table]%$(this).html()%[/table]"},bbToHTML:{"[table](.*?)[/table]":"<table>$1</table>","[tr](.*?)[/tr]":"<tr>$1</tr>","[td](.*?)[/td]":"<td>$1</td>","\n":"<br/>"}}},smileList:[{title:"\u0423\u043b\u044b\u0431\u043a\u0430",img:'<img src="{themePrefix}{themeName}/img/smiles/sm1.png" class="sm">',
